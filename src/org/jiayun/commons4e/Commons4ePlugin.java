...
public class Commons4ePlugin extends AbstractUIPlugin {
	...
	public Commons4ePlugin() {
		...
		plugin = this;
		try {
			resourceBundle = ResourceBundle.getBundle("org.jiayun.commons4e.Commons4ePluginResources");
	...
	public static String getResourceString(String key) {
		ResourceBundle bundle = Commons4ePlugin.getDefault().getResourceBundle();
		try {
